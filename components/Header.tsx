...
export function Header() {
  return <header className="border-b rule"><div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-5 py-3 sm:gap-4 sm:px-8 sm:py-5">
    ...
    <Link href="/quiz" className="shrink-0 text-sm font-bold underline decoration-moss decoration-2 underline-offset-4"><span className="sm:hidden">Start</span><span className="hidden sm:inline">Take the quiz</span></Link>
  </div></header>;
}
