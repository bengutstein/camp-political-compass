...
export function PublicCompass() {
  ...
  const visibleResults = gesherYearFilter === "all" ? savedResults : savedResults.filter((result) => result.gesherYear === Number(gesherYearFilter));
